<?php
/**
 * GenesisPHP - AdmIntegrantes FormularioWeb
 *
...
class FormularioWeb extends DetalleWeb implements \Base2\SalidaWeb {
    ...
    static public $form_name = 'admintegrante'; // Nombre del formulario
    ...
    protected function recibir_formulario() {
        ...
        $this->poder        = \Base2\UtileriasParaFormularios::post_select($_POST['poder']);
    } // recibir_formulario
    ...
    public function html($in_encabezado='') {
        ...
        if ($this->id == 'agregar') {
            ...
            if (!$this->sesion->puede_modificar('adm_integrantes')) {
                $mensaje = new \Base2\MensajeWeb('Aviso: No tiene permiso para modificar integrantes.');
                return $mensaje->html('Error');
            }
            // Consultamos
            try {
