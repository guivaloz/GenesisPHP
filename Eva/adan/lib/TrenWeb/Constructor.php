<?php
/**
 * GenesisPHP - TrenWeb Constructor
 *
...
class Constructor extends \Base\Plantilla {
    ...
    protected function elaborar_constructor_viene_tren() {
        ...
        if (count($b) == 0) {
            die('Error en TrenWeb, Constructor: Es necesario que haya por lo menos una columna como filtro.');
        }
...
{$this->elaborar_constructor_recibir_filtros()}
        ...
        \$this->tren_controlado = new \\Base2\\TrenWebControlado();
