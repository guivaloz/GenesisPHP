<?php
/**
 * GenesisPHP - BusquedaHTML ElaborarFormulario
 *
...
class ElaborarFormulario extends \Base\Plantilla {
    ...
    protected function elaborar_formulario_campo($columna, $datos, $relacion=null, $relacion_columna=null) {
        ...
        switch ($datos['tipo']) {
            ...
            case 'relacion':
                ...
                break;
            default:
                die("Error en BusquedaHTML, ElaborarFormulario, elaborar_formulario_campo: Tipo {$datos['tipo']} no programado al elaborar formulario en $columna.");
        }
        // Entregar
        if ($campo === false) {
    ...
    protected function elaborar_formulario_relacion($columna, $datos) {
        ...
        if (is_array($this->relaciones[$columna])) {
            ...
            die("Error en BusquedaHTML, ElaborarFormulario, elaborar_formulario_relacion: Falta obtener datos de Serpiente para la relación $columna.");
        }
                ...
                if (is_array($vip_datos)) {
                    if ($vip_datos['tipo'] == 'relacion') {
                        if (is_array($this->relaciones[$vip])) {
                            ...
                            die("Error en BusquedaHTML, ElaborarFormulario, elaborar_formulario_relacion: No está definido el VIP en Serpiente para $vip.");
                        }
                    } else {
    ...
    public function php() {
        ...
        if (count($a) > 0) {
            ...
            die('Error en BusquedaHTML, ElaborarFormulario, php: No hay columnas con filtro para crear el método formulario.');
        }
        // Entregar
        return <<<FINAL
    /**
