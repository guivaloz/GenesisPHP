<?php
/**
 * GenesisPHP - AdmIntegrantes BusquedaHTML
 *
...
class BusquedaHTML extends \Base\BusquedaHTML {
    ...
    public function validar() {
        ...
        if ($this->usuario != '') {
            ...
            try {
                ...
                throw new \Base\BusquedaHTMLExceptionValidacion('Aviso: Usuario incorrecto.');
            }
    ...
    public function consultar() {
        ...
        if ($consulta->cantidad_registros() > 1) {
            ...
            // No se encontró nada
            throw new \Base\BusquedaHTMLExceptionVacio('Aviso: La búsqueda no encontró integrantes con esos parámetros.');
        }
    } // consultar
