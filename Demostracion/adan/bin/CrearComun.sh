...
for DIR in AdmAutentificaciones AdmBitacora AdmCadenero AdmDepartamentos AdmIntegrantes AdmModulos AdmRoles AdmSesiones AdmUsuarios Base2 Configuracion Inicio Michelf Personalizar
do
    echo "$SOY Copiando $DIR..."
